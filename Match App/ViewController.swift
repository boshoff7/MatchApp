...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        // Run timer in background so that it does not stop 
    ...
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        // Get the card in the card array
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        // Check if there's any time remaining, dont let the user interact if time is 0
        if milliseconds <= 0 {
            return
        }
        ...
        if cell?.card?.isFlipped == false && cell?.card?.isMatched == false {
            ...
            // Check if this is the first card that is flipped or the second
            
            if firstFlippedCardIndex == nil {
                
                // This is the first card that is flipped
    ...
    func checkForGameEnd() {
        ...
        if hasWon == true {
            ...
            // Then user has won, show an alert
            showAlert(title: "CONGRATULATIONS!", message: "You have won the game!")
            
        } else {
            
            // User has not won yet, check if there is any time left
            if milliseconds <= 0 {
                showAlert(title: "TIME IS UP!", message: "You suck!")
            }
        }
